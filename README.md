...
To start, you need the Arduino IDE with dependencies installed. Hardware setup is described here: ct.de/@@@@.

## Getting started (Server)
The folder 'server' contains examples for content and outputs it in Byte-stream-format for ESP32. Copy the folder on a webserver with PHP installed and GD active (>7.0).
